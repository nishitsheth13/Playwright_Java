...
public class manageInvoice extends browserSelector {

    public static basicTemplate.pages.manageInvoice Invoice = new basicTemplate.pages.manageInvoice();
